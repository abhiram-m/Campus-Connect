...
<body class="feeding">
 ...
 %>
														...
														<div class="panel panel-default">
															<form action="PostRoomMateFeed" method="post">
																...
																<div class="panel-body">
																	...
																	</label><a href="SearchRoommate?searchstring=Roommate"><img src="CSS/images/searchicon.png"></a>
																	 <label class="radio-inline"><input
																		type="radio" name="optradio" value="House">House</label><a href="SearchRoommate?searchstring=House"><img src="CSS/images/searchicon.png"></a>
																	<br> <br>
									...
									<!-- Post Starts-->
									<%
									String rms = (String)session.getAttribute("rmsearch");
										comment = newsfeed;
										for (int i = 0; i < newsfeed.size(); i++) {
											if ((newsfeed.get(i).getParentID()).equals("0") && newsfeed.get(i).getRoommatetype().equals(rms)) {
									%>
									<!-- Post Starts-->
 ...
 %>
																 ...
																 <a style="float: right;"href="Deletepostnew?linkname=<%=newsfeed.get(j).getID()%>">Delete</a>
																<% } %>	
