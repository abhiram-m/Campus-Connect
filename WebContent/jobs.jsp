		...
		<!-- New post -->
				<div class="media-body">
                     ...
                     <h3>Posted Jobs:</h3>
								  ...
								  <select  name ="filt" id="mySelect" onchange="myFunction()">
								  <option value="Id">Id
								  <option value="deadlinedate">deadlinedate
...
<c:set var="empId" value= "<%=filter %>"/>
<sql:query dataSource="${snapshot}" var="result">
   SELECT * from jobportal order by <c:out value="${empId}"/>  ;
